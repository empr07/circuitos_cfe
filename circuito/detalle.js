...
if (id_circuito > 0) {
    fetch("https://apicfe.onrender.com/api/circuitos/" + id_circuito, {
        ...
        document.getElementById("idarea").innerHTML = data.area.nombre
        document.getElementById("idsubestacion").innerHTML = data.subestacion.nombre
        document.getElementById("idnumcirc").innerHTML = data.numcirc.numero
